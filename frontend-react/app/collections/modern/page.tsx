      ...
      <section className="relative bg-primary text-primary-foreground py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <h1 className="font-serif text-4xl md:text-5xl font-bold tracking-tight">Modern Collection</h1>
            <p className="text-lg text-primary-foreground/90 leading-relaxed">
              Contemporary designs for the modern individual
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Our Modern Collection blends innovative fabrics with sleek, minimalist designs. Perfect for the
              contemporary lifestyle, these pieces transition seamlessly from work to weekend while maintaining the
              quality and attention to detail that defines CCB.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {products.filter(p => p.categoryId === "modern").map((product) => (
