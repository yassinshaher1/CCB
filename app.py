...
def get_products():
    ...
    # Firebase returns a dictionary {id: content, id: content}.
    # We convert it to a list [content, content] for the frontend.
    product_list = []
...
def add_product(product: Product):
    ...
    # push() creates a unique ID automatically (like {productId} in your JSON)
